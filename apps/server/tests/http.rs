...
async fn hlt03_task_lifecycle_routes_are_wired() {
    ...
    for (method, path) in [
        ...
        (
            "GET",
            "/v1/projects/00000000-0000-0000-0000-000000000001/topics/00000000-0000-0000-0000-000000000002/info-documents",
        ),
        (
            "POST",
            "/v1/projects/00000000-0000-0000-0000-000000000001/task-lists/00000000-0000-0000-0000-000000000002/info-documents",
        ),
        (
            "PUT",
            "/v1/projects/00000000-0000-0000-0000-000000000001/info-documents/00000000-0000-0000-0000-000000000002",
        ),
        (
            "DELETE",
            "/v1/projects/00000000-0000-0000-0000-000000000001/info-documents/00000000-0000-0000-0000-000000000002",
        ...
        (
            "POST",
            "/v1/projects/00000000-0000-0000-0000-000000000001/info-documents/00000000-0000-0000-0000-000000000002/files",
        ),
        (
            "GET",
